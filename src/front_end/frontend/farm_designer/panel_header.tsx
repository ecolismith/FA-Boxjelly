...
export const TAB_COLOR: Record<Panel, PanelColor> = {
  ...
  [Panel.Camera]: PanelColor.gray,
  [Panel.Analysis]: PanelColor.gray,
...
export const TAB_ICON: Record<Panel, string> = {
  ...
  [Panel.Camera]: FilePath.icon(Icon.photos),
  [Panel.Analysis]: FilePath.icon(Icon.settings),
...
export const PANEL_TITLE = (): Record<Panel, string> => ({
  ...
  [Panel.Logs]: t("Logs"),
  [Panel.Help]: t("Help"),
  [Panel.Camera]: t("Camera"),
  [Panel.Analysis]: t("Analysis"),
