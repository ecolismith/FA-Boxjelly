...
exports.fadeIn = exports.Horizontal = exports.Vertical = exports.AlertSuccess = exports.Alert = exports.Button = exports.buttonClass = void 0;
...
var Alert = function (props) { return React.createElement("div", { style: { padding: '10px', backgroundColor: '#ffa3a3', color: '#883b3b' } }, props.children); };
exports.Alert = Alert;
var AlertSuccess = function (props) { return React.createElement("div", { style: { padding: '10px', backgroundColor: '#f0ffef', color: '#43883b' } }, props.children); };
exports.AlertSuccess = AlertSuccess;
var Vertical = function (_a) {
