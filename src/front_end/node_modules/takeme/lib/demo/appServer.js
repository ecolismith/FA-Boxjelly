...
exports.Profile = exports.Login = exports.Nav = void 0;
/** Normalize JS */
require("core-js");
/** Normaize CSS */
...
var Link = function (props) {
    return React.createElement("a", { onClick: function (e) { return index_1.html5LinkOnClick({ event: e.nativeEvent }); }, href: props.href, target: props.target, children: props.children });
};
/**
...
exports.Nav = mobx_react_1.observer(function () {
    return React.createElement(components_1.Vertical, null,
        routeState_1.routeState.loggedIn && React.createElement(components_1.Horizontal, null,
            React.createElement(Link, { href: index_1.link(links_1.links.profile('dave')) }, "Dave"),
            React.createElement(Link, { href: index_1.link(links_1.links.profile('john')) }, "John")),
        ...
        React.createElement(components_1.Horizontal, null,
            React.createElement(Link, { href: 'https://github.com/basarat/takeme/tree/master/src/demo', target: "_blank" }, "Code for the demo"),
            React.createElement(Link, { href: 'http://basarat.com/takeme', target: "_blank" }, "takeme Docs"),
            React.createElement(Link, { href: 'https://github.com/basarat/takeme', target: "_blank" }, "Star it on github \u2B50")));
});
/**
 * Pages
 */
...
router_1.router.enableHtml5Routing('/takeme-demo/awesome').init();
