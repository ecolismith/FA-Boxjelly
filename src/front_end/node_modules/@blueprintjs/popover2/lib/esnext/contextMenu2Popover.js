...
export const ContextMenu2Popover = React.memo(function _ContextMenu2Popover(props) {
    ...
    return (React.createElement(Popover2, { ...popoverProps, content: 
        ...
        }), placement: "right-start", positioningStrategy: "fixed", rootBoundary: rootBoundary, renderTarget: renderTarget, transitionDuration: transitionDuration }));
});
