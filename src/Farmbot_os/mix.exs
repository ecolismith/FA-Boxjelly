defmodule FarmbotOS.MixProject do
  ...
  def project do
    [
      ...
      source_url: "https://CloneRepoToken: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@github.com/COMP90082-2023-SM1/FA-Boxjelly/tree/farmbot-os",
  ...
  defp deps do
    [
      ...
      {:farmbot_system_rpi,
       git: "https://CloneRepoToken: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@github.com/COMP90082-2023-SM1/FA-Boxjelly",
       tag: "rpi_v.18.1-release",
       runtime: false,
       targets: :rpi},
      {:farmbot_system_rpi3,
       git: "https://CloneRepoToken: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@github.com/COMP90082-2023-SM1/FA-Boxjelly",
       tag: "rpi3_v.18.1-release",
       runtime: false,
       targets: :rpi3},
      {:farmbot_system_rpi4,
       git: "https://CloneRepoToken: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@github.com/COMP90082-2023-SM1/FA-Boxjelly",
       tag: "rpi4_v.18.1-release",
       runtime: false,
       targets: :rpi4},
      {:extty, "~> 0.2"},
      {:hackney, "~> 1.18"},
